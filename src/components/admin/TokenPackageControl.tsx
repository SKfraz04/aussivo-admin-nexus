...
import { Coins, Package, Settings, Plus } from 'lucide-react';
        ...
        <Card className="glassmorphism border-emerald-800/30">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input className="bg-slate-800/50 border-slate-600 text-white" value="1,000,000 ASVO" readOnly />
            </div>
            <div>
              <label className="text-slate-300 text-sm">Circulating Supply</label>
              <Input className="bg-slate-800/50 border-slate-600 text-white" value="750,000 ASVO" />
            </div>
