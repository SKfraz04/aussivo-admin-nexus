        ...
        <Card className="glassmorphism border-emerald-800/30">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input className="bg-slate-800/50 border-slate-600 text-white" value="5.0" />
            </div>
            <div>
              <label className="text-slate-300 text-sm">Referee Bonus (%)</label>
              <Input className="bg-slate-800/50 border-slate-600 text-white" value="2.5" />
            </div>
            <div>
              <label className="text-slate-300 text-sm">Max Referral Levels</label>
              <Input className="bg-slate-800/50 border-slate-600 text-white" value="3" />
            </div>
